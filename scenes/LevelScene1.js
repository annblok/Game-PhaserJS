class LevelScene1 extends Phaser.Scene {
    ...
    preload() {
        this.load.image('background', 'https://annblok.github.io/Game-PhaserJS/assets/images/bg-1.png');
        this.load.image('land', 'https://annblok.github.io/Game-PhaserJS/assets/images/ground.png');
        this.load.image('coin', 'https://annblok.github.io/Game-PhaserJS/assets/images/coin.png');
        this.load.spritesheet('player', 'https://annblok.github.io/Game-PhaserJS/assets/images/player.png', {
            frameWidth: 136,
            frameHeight: 140
        });
        this.load.spritesheet('enemy', 'https://annblok.github.io/Game-PhaserJS/assets/images/enemy.png', {
            frameWidth: 79,
            frameHeight: 110
        });
        this.load.audio('soundJump', 'https://annblok.github.io/Game-PhaserJS/assets/audio/jump.wav');
        this.load.audio('soundCoins', 'https://annblok.github.io/Game-PhaserJS/assets/audio/coins.wav');
    }

    create() {
        this.add.image(2000, 222, 'background');
        ...
        const restartBtn = this.add.text(650, 20, 'МЕНЮ', {
            font: '14px Fira Sans',
            fill: '#ffffff',
        ...
        this.soundCoins = this.sound.add('soundCoins');
    }
